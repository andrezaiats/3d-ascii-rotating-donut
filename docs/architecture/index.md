...
- [3D ASCII Rotating Donut with Self-Code Display Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    - [Point3D](./data-models.md#point3d)
    - [Point2D](./data-models.md#point2d)
    - [CodeToken](./data-models.md#codetoken)
    - [TorusParameters](./data-models.md#torusparameters)
    - [DisplayFrame](./data-models.md#displayframe)
  - [Components](./components.md)
    - [MathematicalEngine](./components.md#mathematicalengine)
    - [ParsingEngine](./components.md#parsingengine)
    - [RenderingEngine](./components.md#renderingengine)
    - [AnimationController](./components.md#animationcontroller)
    - [Component Diagrams](./components.md#component-diagrams)
  - [External APIs](./external-apis.md)
  - [Core Workflows](./core-workflows.md)
    - [Application Startup and Initialization](./core-workflows.md#application-startup-and-initialization)
    - [Core Animation Frame Generation](./core-workflows.md#core-animation-frame-generation)
    - [Self-Referential Token Processing](./core-workflows.md#self-referential-token-processing)
  ...
  - [Test Strategy and Standards](./test-strategy-and-standards.md)
    ...
    - [Test Types and Organization](./test-strategy-and-standards.md#test-types-and-organization)
      ...
      - [Visual Validation Tests](./test-strategy-and-standards.md#visual-validation-tests)
